...
| [De¹](plugins/de1.md) | Swap tokens or aggregate DEX routes on De¹. | DEX quote discovery, token swap calldata generation, submit via `send_calls`. | Base mainnet. Quotes can move; confirm slippage before writes. |
